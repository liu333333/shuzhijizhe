...
const Authorization = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI3NzAiLCJpYXQiOjE3NzMyODQwMzh9.NPE3R0KtK1HBeDF61v72W3KVzbBui6BXGIVfRwhJK-s"
...
const loadAsk = async () => {
	...
	const response = await axios({
        method: 'POST',
        url: "https://szjz-beta.dahe.cn/api/pro/attachment/list?apipost_id=2c2c342eb9f2fb",
        headers: {
...
const fetchData = async (query) => {
	...
	try {
		const response = await axios({
            ...
            url: "https://szjz-beta.dahe.cn/api/pro/chat/chat-messages",
			headers: {
				Authorization: Authorization
			},
			data: {
